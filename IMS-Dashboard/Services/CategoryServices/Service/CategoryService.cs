...
namespace IMS_Dashboard.Services.CategoryServices.Service
{
    public class CategoryService : ICategoryService
    {
        ...
        public CategoryService(HttpClient httpClient, IMemoryCache cache, IcategoryRepository categoryRepo, ILogger<CategoryService> logger)
        {
        ...
        public async Task<IEnumerable<DisplayCategoryViewModel>> GetAllCategories()
        {
            ...
            try
            {
                ...
                return categories.Select(c => new DisplayCategoryViewModel
                {
                    id = c.Id,
